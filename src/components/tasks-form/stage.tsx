...
type iStageFormProps = {
  isLoading?: boolean;
};

export const StageForm = ({ isLoading }: iStageFormProps) => {
  ...
  return (
    <div style={{ padding: '12px 24px', borderBottom: 'ipx solid #d9d9d9' }}>
      <Form
        layout='inline'
      ...
      >
        ...
        <Form.Item noStyle name='completed' valuePropName='checked'>
          <Checkbox>Mark as Compledted</Checkbox>
        </Form.Item>
      </Form>
    </div>
  );
